...
def install_packages(section):
    ...
    dependencies = {
        "section0": ["pyarrow", "pandas"],                                                 # Add dependencies for section0
        "section1": ["pyarrow", "pandas", "numpy", "matplotlib", "seaborn", "wordcloud"],  # Add dependencies for section1
        "section2": [""],                                                                  # Add dependencies for section2
        "section3": [""],                                                                  # Add dependencies for section3
        "section4": [""],                                                                  # Add dependencies for section4
    }
